module.exports = {
  ...
  run: async (m, {
    ...
    let isAll = false;
    let isUser = false;
    let g = ["game", "welcome", "antibot", "antilink", "antivirtex", "antisticker"];
    ...
    m.reply(`*${type}* successfully *${isEnable ? "enable" : "disable"}* ${isAll ? "for this bot" : isUser ? "" : "for this group"}`.trim());
  }
};