...
const commands = [{
  ...
  description: "Generates a voice message response using Yoshida's persona. Important: Use Yoshida's distinct speaking style, including specific word choices and punctuation to make it sound realistic.",
  parameters: {
    type: "object",
    properties: {
      message: {
        type: "string",
        description: "The message content for the voice message. Use Yoshida's style. Include emojis."
      }
    },
    required: ["message"]
  }
  ...
  parameters: {
    ...
    properties: {
      action: {
        ...
        description: "The action to perform: 'opengroup' or 'closegroup'."
      }
    },
    required: ["action"]
  }
  ...
  name: "generate_photo",
  description: "Generates a photo of Yoshida based on a text prompt. IMPORTANT: Prompt must be in English.",
  parameters: {
    type: "object",
    properties: {
      prompt: {
        type: "string",
        description: "A text prompt describing Yoshida's appearance and pose (in English). Include details to create a realistic photo."
      }
    },
    required: ["prompt"]
  }
  ...
  parameters: {
    ...
    properties: {
      query: {
        type: "string",
        description: "The title or keywords to search for on YouTube."
      }
    },
    required: ["query"]
  }
  ...
  parameters: {
    ...
    properties: {
      query: {
        type: "string",
        description: "The song title or keywords to search audio from YouTube."
      }
    },
    required: ["query"]
  }
  ...
  name: "generate_image",
  description: "Generates an image based on a text prompt. IMPORTANT: Prompt must be in English.",
  parameters: {
    type: "object",
    properties: {
      prompt: {
        type: "string",
        description: "A text prompt describing the image to generate (in English)."
      }
    },
    required: ["prompt"]
  }
